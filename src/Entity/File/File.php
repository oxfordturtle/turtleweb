...
class File
{
    ...
    /** --- OWNER
     * @ORM\ManyToOne(targetEntity="App\Entity\User\User", inversedBy="files")
     */
    private $owner;
    ...
    /** --- UPLOADED_DATE
     * @ORM\Column(name="uploaded_date", type="date")
     */
    ...
    /** --- FOLDERS
     * @ORM\ManyToMany(targetEntity="App\Entity\Folder\Folder", mappedBy="files")
